      ...
      <div className="background">
        ...
        <div className="background-text">
          <p>
            ...
            my master I had the opportunity to publish a{' '}
            <a
              rel="noreferrer"
              target="_blank"
              href="https://aclanthology.org/2021.maiworkshop-1.1/"
            >
              <span>research paper</span>
            </a>{' '}
            on multimodal AI at the <span>NAACL 2021 Conference</span> .{' '}
            <br></br> <br></br>
            On my free time I love collaborating on open source communities and
            AI for good organizations. I'm currently working with{' '}
            <span>Omdena Mexico Chapter</span>, where I've had the opportunity
            to work on a project related to identifying Fake News on the web by
            developing a Google Chrome extension. I'm also an active
            collaborator in the Spanish HuggingFace community called{' '}
            <span>Somos NLP</span>.
          </p>
        </div>
      </div>
